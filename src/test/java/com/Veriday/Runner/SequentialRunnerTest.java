...
import com.Veriday.Util.CustomFormatter;
...
@CucumberOptions(
		...
		glue = { "com.Veriday.StepDefinition" },
		plugin = { "junit:target/cucumberJunit.xml" , "com.Veriday.Util.CustomFormatter"},
		dryRun = false
		)
